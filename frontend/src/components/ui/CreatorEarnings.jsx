    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-500 dark:text-gray-400">
          Tips from supporters will appear here after your models receive activity.
        </p>
      </div>
    )
  }
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-2xl font-bold text-green-900 dark:text-green-100">
                INR {earnings.totalEarnings.toFixed(2)}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <p className="text-2xl font-bold text-purple-900 dark:text-purple-100">
                INR {earnings.averageTip.toFixed(2)}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-800 dark:text-blue-200 mt-1">
              You can withdraw your earnings once you reach INR 100. Set up your payment method in your profile settings.
            </p>
            <button 
