...
const PageMeta = ({ 
  ...
  const siteName = '3D ShareSpace'
  const origin = 'https://3dsharespace.com'
    ...
    const structuredData = [
      {
        ...
        "name": siteName,
        "alternateName": ["3DShareSpace", "3D Share Space"],
        "url": origin,
        "logo": `${origin}/favicon.svg`,
        "description": "Free 3D model sharing platform for artists, game developers, archviz artists, students, educators, and small studios.",
        "contactPoint": {
          "@type": "ContactPoint",
      ...
      },
      {
        ...
        "@id": `${origin}/#website`,
        "name": siteName,
        "alternateName": ["3DShareSpace", "Free 3D Model Library"],
        "url": origin,
        "description": "Browse and download free 3D models for renders, games, AR/VR, product scenes, architecture, education, and studio projects.",
        "publisher": {
          "@id": `${origin}/#organization`
        },
        "inLanguage": "en",
