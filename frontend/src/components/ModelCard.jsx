...
// ⚡ Bolt: Wrapped in React.memo to prevent unnecessary O(N) re-renders
// Performance Impact: Significantly reduces UI lag when typing in search inputs
// on parent components (like Explore.jsx and Home.jsx) that trigger full-page renders.
