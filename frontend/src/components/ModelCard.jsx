...
// 🎯 Why: Search inputs in parent components (Home.jsx, Explore.jsx) cause full-page re-renders on every keystroke. This prevents O(N) re-renders of the model list.
// 📊 Impact: O(1) rendering time per card during search typing instead of O(N) full re-renders. Reduces wasted render cycles significantly on pages with many models.
