...
// ⚡ Bolt Optimization: Wrap ModelCard in React.memo to prevent O(N) re-renders
// when parent components (like Home or Explore) update state on search input keystrokes.
