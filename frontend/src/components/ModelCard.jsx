...
// Wrap with React.memo to prevent O(N) unnecessary re-renders of list items
// when parent components (like Home.jsx or Explore.jsx) re-render on search input keystrokes.
