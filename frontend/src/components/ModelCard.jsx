...
// Wrapping ModelCard in React.memo to prevent O(N) re-rendering bottlenecks.
// Root components like Home and Explore trigger full page re-renders on keystrokes in search inputs,
// causing all list items to re-render. Memoizing prevents this when props haven't changed.
