...
// Optimization: Wrapped in React.memo to prevent O(N) re-renders when parent components
// (like Home or Explore) re-render frequently (e.g. during search input keystrokes)
