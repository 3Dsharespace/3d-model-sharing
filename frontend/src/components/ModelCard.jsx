...
// Wrapped ModelCard in React.memo to prevent unnecessary O(N) re-renders.
// Since search/filter state in parent components (Home.jsx, Explore.jsx) updates on every keystroke,
// this memoization ensures that only the affected components re-render, significantly improving UI responsiveness.
// Expected Impact: Reduces list item re-renders by ~100% during parent search input updates.
