...
// when parent components (like Home.jsx or Explore.jsx) update their search query state
// on every keystroke, ensuring we only re-render if the model props change.
