...
// Wrapped in React.memo to prevent O(N) re-renders in list views (Explore/Home)
// when parent component state changes (e.g. typing in search box).
// Impact: Significantly reduces main thread blocking during search keystrokes.
