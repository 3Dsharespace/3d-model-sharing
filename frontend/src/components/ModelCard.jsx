...
// (like Home or Explore) re-render due to search input changes. This optimization
// is critical because search inputs trigger re-renders on every keystroke, which
// otherwise causes an O(N) re-render of all listed ModelCards.
