...
// ⚡ Bolt: Wrapped in React.memo to prevent O(N) re-renders when parent components (like Home/Explore)
// re-render on search input changes or unrelated state updates.
