...
// Wrap with React.memo to prevent O(N) re-renders when parent components
// (like Explore or Home) update their search input state on every keystroke.
// This prevents unnecessary re-rendering of the entire list of models when
// the underlying model data hasn't changed.
