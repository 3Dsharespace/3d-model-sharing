...
// Wrapped ModelCard in React.memo to prevent O(N) re-renders when parent components
// (like Explore or Home) update their state on search input keystrokes.
// Expected Impact: Significantly reduces UI lag during search by preventing
// re-rendering of the entire model list on every keystroke.
