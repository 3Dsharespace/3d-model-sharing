...
// Performance optimization: Wrap in React.memo to prevent O(N) re-renders
// Impact: Significantly reduces rendering time on pages with large grids (e.g. Home, Explore) when search input or other local state changes.
