...
// when parent components (like Home or Explore) update their search state on every keystroke.
// Expected impact: Significantly improves typing responsiveness on pages displaying lists of models.
