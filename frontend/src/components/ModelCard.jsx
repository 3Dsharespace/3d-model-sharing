...
// Optimization: Wrap ModelCard in React.memo to prevent O(N) re-renders when root components (like Home/Explore) trigger full page updates on search input keystrokes.
