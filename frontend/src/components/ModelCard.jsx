...
// ⚡ Bolt Optimization: Memoize ModelCard to prevent unnecessary re-renders in list views
// This significantly improves performance on pages like Explore and Home which render many cards
