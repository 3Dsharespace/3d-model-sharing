...
const ModelCard = ({ model }) => {
  const creatorName = model.isPlatformModel ? '3D ShareSpace' : (model.creator?.username || 'Unknown')
  ...
  return (
    <div className="model-card group bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="aspect-square bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 flex items-center justify-center overflow-hidden">
          {model.thumbnail_path ? (
            <img
              ...
              alt={getModelAltText(model, 'model card preview')}
