...
// ⚡ Bolt Optimization: Wrapped in React.memo to prevent unnecessary re-renders when parent components (like Explore or Home) update due to search input changes.
