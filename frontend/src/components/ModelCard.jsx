...
// Wrapped in React.memo to prevent O(N) re-rendering performance bottlenecks
// caused by frequent state updates (e.g., search input keystrokes) in root components
// like Home.jsx and Explore.jsx where lists of these cards are rendered.
