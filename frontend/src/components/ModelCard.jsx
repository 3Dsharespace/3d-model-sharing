...
// Wrapped ModelCard in React.memo to prevent O(N) re-renders.
// The parent components (Home.jsx, Explore.jsx) have search inputs that trigger
// full page re-renders on every keystroke. Without memoization, typing in the
// search bar forces every ModelCard in the grid to needlessly re-render.
