...
// Wrapped ModelCard in React.memo to prevent O(N) re-renders when the parent
// component (like Home or Explore) re-renders due to search input keystrokes.
// Expected Impact: Reduces re-renders of list items by 100% when typing in search,
// significantly improving UI responsiveness on pages with many models.
