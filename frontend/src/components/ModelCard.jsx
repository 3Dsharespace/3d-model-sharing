...
// Optimization: Wrapping ModelCard in React.memo prevents O(N) re-renders when
// parent components (like Home or Explore) update their state during search input.
