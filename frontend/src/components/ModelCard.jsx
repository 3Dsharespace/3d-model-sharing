...
// ⚡ Bolt Optimization: Wrap ModelCard in React.memo()
// Prevents O(N) re-renders when parent components (Home/Explore) update search inputs on keystrokes
// Expected Impact: Reduces re-renders of list items by 100% during search input typing
