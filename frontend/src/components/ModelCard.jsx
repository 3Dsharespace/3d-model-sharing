...
// Optimization: Wrap ModelCard in React.memo to prevent unnecessary O(N) re-renders
// when parent components (like Home.jsx and Explore.jsx) re-render frequently,
// such as during search input keystrokes.
