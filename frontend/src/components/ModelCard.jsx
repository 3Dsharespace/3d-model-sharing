...
// Wrapped ModelCard in React.memo to prevent O(N) unnecessary re-renders
// when root components (like Home.jsx and Explore.jsx) update their search state on keystroke.
