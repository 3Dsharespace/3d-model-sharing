...
// ⚡ Bolt Optimization: Wrapped in React.memo to prevent O(N) re-renders when parent lists update on keystrokes.
// Expected impact: Significant reduction in render time during search or filtering operations.
