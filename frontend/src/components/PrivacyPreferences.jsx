...
const PrivacyPreferences = () => {
  ...
  return (
    <>
      {/* Main Banner */}
      {!showSettings && (
        <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-[#242424] bg-[#080808]/95 text-[#f5f5f5] shadow-none">
          <div className="mx-auto max-w-7xl px-4 py-3 sm:px-6 lg:px-8">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex flex-1 items-start gap-3">
                <div className="mt-0.5 flex h-7 w-7 flex-shrink-0 items-center justify-center border border-[#242424] bg-[#101010]">
                  <Cookie className="h-3.5 w-3.5 text-[#a3a3a3]" />
                </div>
                <div className="flex-1">
                  <h3 className="mb-0.5 text-sm font-semibold text-[#f5f5f5]">
                    Cookie preferences
                  </h3>
                  <p className="text-xs leading-5 text-[#a3a3a3]">
                    We use cookies for site function, analytics, and advertising.
                    {region === 'eea_uk' && (
                      <span className="ml-1 text-[#a3a3a3]">You can choose optional cookies.</span>
                    )}
                    <button 
                      onClick={() => setShowSettings(true)}
                      className="ml-1 font-semibold text-[#f5f5f5] hover:text-white"
                    >
                      Manage
                    </button>
                  </p>
              ...
              <div className="flex flex-shrink-0 items-center gap-2">
                <button
                  ...
                  className="border border-[#303030] bg-[#101010] px-3 py-2 text-xs font-semibold text-[#d4d4d4] transition-colors hover:bg-[#141414] hover:text-white"
                >
                  Essential Only
                </button>
                <button
                  onClick={handleAcceptAll}
                  className="bg-[#f5f5f5] px-3 py-2 text-xs font-semibold text-black transition-colors hover:bg-white"
                >
                  Accept All
                </button>
                <button
                  onClick={() => setShowBanner(false)}
                  className="p-2 text-[#737373] transition-colors hover:text-[#f5f5f5]"
                >
                  <X className="h-4 w-4" />
                </button>
              </div>
