...
const Explore = () => {
  ...
  // Derived state (filtering/sorting) is now computed synchronously during render using useMemo.
  // This avoids a redundant render cycle that occurs when updating derived state in a useEffect.
