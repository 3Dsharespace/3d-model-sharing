...
const Explore = () => {
  ...
  // Memoize filtered and sorted models to prevent unnecessary re-renders
  // Previously this was a useEffect updating a separate state, causing double-renders
  const filteredModels = useMemo(() => {
    ...
    filtered.sort((a, b) => {
      switch (sortBy) {
        case 'newest':
          // Optimization: use getTime() for slightly faster date comparisons
          return new Date(b.created_at || 0).getTime() - new Date(a.created_at || 0).getTime()
        case 'popular':
        case 'downloads': // Both popular and downloads use downloads_count currently
