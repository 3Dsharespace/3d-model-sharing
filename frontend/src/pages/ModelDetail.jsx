...
const ModelDetailPage = () => {
  ...
  return (
    <div className="studio-page model-detail-page">
      <PageMeta
        title={modelSeoTitle}
        ...
        <section className="model-detail-layout">
          <div className="min-w-0">
            <div className="model-detail-preview">
              <div className="model-detail-preview__stage">
                <img
                  src={activeImage}
            ...
            <div className="model-detail-comments">
          ...
          <aside className="model-detail-rail">
              ...
              {model?.userId && (
                <div className="mt-4">
                  <TipButton
                    ...
                    modelId={model.id || model.uid || modelId}
                    modelTitle={model.title || model.name || '3D model'}
                    variant="small"
                    className="w-full"
                  />
                </div>
