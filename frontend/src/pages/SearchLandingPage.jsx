  ...
  return (
    <div className="min-h-screen bg-luxury-bg-primary dark:bg-black">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-4xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              {page.ctaUrl?.startsWith('/explore') ? (
                <ExploreHighlight>
                  <Link
                    to={page.ctaUrl}
      ...
      <section className="px-4 pb-14 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl border-t border-luxury-border-light pt-8 dark:border-gray-800">
          <h2 className="mb-5 text-2xl font-semibold text-gray-950 dark:text-white">Questions about {page.name} assets</h2>
          <div className="grid gap-4 lg:grid-cols-2">
            {faqs.map((faq) => (
              <article key={faq.question} className="border border-gray-300 bg-white p-5 dark:border-gray-800 dark:bg-black">
                <h3 className="text-base font-semibold text-gray-950 dark:text-white">{faq.question}</h3>
                <p className="mt-3 text-sm leading-6 text-gray-700 dark:text-gray-300">{faq.answer}</p>
              </article>
            ))}
          </div>
        </div>
