...
const ProfileEdit = () => {
  ...
  return (
    <div className="studio-profile-edit min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            ...
            <p>
              Keep your public profile useful for artists, studios, students, and developers browsing your models.
            </p>
            <div className="profile-edit-links">
              <a href="/explore">Asset library</a>
              <a href={`/profile/${user.uid}`}>View profile</a>
              <a href="/creator-tier">Creator tier</a>
            </div>
          </div>
          <div className="profile-edit-score">
        ...
        <motion.div 
          ...
          className="profile-edit-shell"
        >
          <div className="profile-edit-shell__header">
            <div className="flex items-center space-x-4">
              <div className="profile-edit-shell__icon">
                <Settings className="w-5 h-5" />
              </div>
              <div>
                <h2>Profile editor</h2>
                <p>Update identity, portfolio links, payment settings, and account preferences.</p>
              </div>
            </div>
          </div>
