...
const Dashboard = () => {
  ...
  const recentModels = useMemo(() => (
    [...models].sort((a, b) => new Date(b.createdAt || b.created_at || b.updatedAt || b.updated_at || 0) - new Date(a.createdAt || a.created_at || a.updatedAt || a.updated_at || 0)).slice(0, 12)
  ), [models])
            ...
            <section className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
              <div>
                <div className="studio-section-title mt-0">
                  <div>
                    <h2>Recent models</h2>
                    <p>Showing {recentModels.length} newest uploads from {models.length} total.</p>
                  </div>
                  <div className="flex gap-3">
                    <Link to="/explore?mine=1">View in library</Link>
