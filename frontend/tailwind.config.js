...
export default {
  ...
  theme: {
    extend: {
      ...
      spacing: {
        'apple-1': 'var(--apple-space-1)',
        'apple-2': 'var(--apple-space-2)',
        'apple-4': 'var(--apple-space-4)',
        'apple-6': 'var(--apple-space-6)',
        'apple-8': 'var(--apple-space-8)',
        'touch': 'var(--apple-touch-min)',
      },
      transitionTimingFunction: {
        apple: 'var(--apple-ease)',
      },
      transitionDuration: {
        apple: 'var(--apple-duration)',
        'apple-fast': 'var(--apple-duration-fast)',
      },
      animation: {
